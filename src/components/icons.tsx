...
export function CrossIcon({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
      <path d="M12 4v16M7 9h10" strokeLinecap="round" />
    </svg>
  );
}
...
export function BibleIcon({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
...
export function UmbrellaIcon({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3a9 9 0 00-9 9h4a2 2 0 012 2v2a2 2 0 004 0v-2a2 2 0 012-2h4a9 9 0 00-9-9z" />
    </svg>
  );
}
